...
pub enum LibraryError {
    ...
    #[error("no entry point found in the loaded Vulkan library")]
    MissingEntryPoint,
}
...
impl Library {
    ...
    pub unsafe fn from_library(inner: libloading::Library) -> Result<Arc<Self>, LibraryError> {
        let ep = *inner
    ...
    pub unsafe fn from_path(path: impl AsRef<Path>) -> Result<Arc<Self>, LibraryError> {
    ...
    pub fn new() -> Result<Arc<Self>, LibraryError> {
        #[cfg(target_os = "linux")]
